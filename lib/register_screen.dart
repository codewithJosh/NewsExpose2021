          ...
          .then((user) {
            ...
            addUser() async {
              ...
              if (!documentSnapshot.exists) {
                ...
                const userBio = '';
                const userImage = 'https://firebasestorage.googleapis.com/v0/b/news-expose-2k21.appspot.com/o/Res_20221117%2Fdefault_user_image.png?alt=media&token=8117d47e-2021-4ef8-81c0-7ce0c0c13b3e';
            ...
            addUser().then((_) {
              ...
              buildFlutterToast('You\'re Successfully Added!', colorElectricGreen, isLong: true);
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Focus(
                                    onFocusChange: (_) => onFocusChange(_formKey),
                                    child: TextFormField(
                                      inputFormatters: [
                                      ...
                                      decoration: initInputDecoration('Username'),
                                      ...
                                      onSaved: (input) => _username = input!.trim().toLowerCase(),
                                    ),
                                  ),
                                  const SizedBox(height: 20.0,),
                                  ...
                                  Focus(
                                    ...
                                    child: TextFormField(
                                      ...
                                      validator: (input) {
                                        ...
                                        } else if (!input.endsWith('@ne.xpose')) {
                                          return 'Must end with @ne.xpose';
                                        } else if (input.length < 10) {
                                          return 'Provide a valid Email Address';
                                        } return null;
                                      },
                                      onSaved: (input) => _email = input!.trim().toLowerCase(),
                                    ),
                                  ),
                                  const SizedBox(height: 20.0,),
                                  ...
                                  Focus(
                                    ...
                                    child: TextFormField(
                                      style: const TextStyle(color: colorFulvous),
                                      decoration: initInputDecoration('Re-Enter Password'),
                                      obscureText: true,
                                      ...
                                      onSaved: (input) => _rePassword = input!.trim(),
                                    ),
                                  ),
                                  ...
                                  initTextButton(context, 'Already have an account?', 'Sign In', 225.0),
